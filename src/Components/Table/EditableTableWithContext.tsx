...
import { EditableTableWithContextCell } from "./EditableTableWithContextCell";


const EditableTableWithContext = ({ dataSource, configUniqueKey, columnTemplates, useUpdateCol = false }: MainTableProps) => {
...
<Form form={form} component={false}>
  <div className="table-container centered-table">
    <Table<RowType>
      components={{
        body: { cell: EditableTableWithContextCell },
      }}
      bordered
      dataSource={data}
      columns={
...
export default EditableTableWithContext;
